...
def is_red_suit(input_image, thresh, target_regions, percentage_red):
    ...
    for i in np.arange(2):
        ...
        for y in np.arange(region_height - 5):
            for x in np.arange(region_width - 5):
                b, g, r = regions[i][y, x]
                # print x, b, g, r
...
def find_squares(input_image):
    ...
    # cv2.drawContours(cpy, best_contour, -1, (0, 255, 0), 2)
    # cv2.imwrite("qcont.jpg", cpy)
